...
public class Info {
    ...
    public void set320filesize(long filesize_320) {
        this.filesize_320 = filesize_320;
    }

    public long get320filesize() {
        return filesize_320;
    }
    ...
    public void set320hash(String hash_320) {
        this.hash_320 = hash_320;
    }

    public String get320hash() {
        return hash_320;
    }
    ...
    public void set320privilege(int privilege_320) {
        this.privilege_320 = privilege_320;
    }

    public int get320privilege() {
